        ...
        children: [
          {
            ...
            duration: 3200,
            attrs: { model: "gpt-4-turbo", tokens: 456, cost: 0.0234 },
          },
          {
            name: "Search Knowledge Base",
            kind: "tool_call" as const,
            duration: 1200,
            attrs: { tool: "vector_search", results: 8 },
          },
          {
            name: "Generate Response",
            kind: "llm_call" as const,
            duration: 5800,
            attrs: { model: "gpt-4", tokens: 2134, cost: 0.0876 },
          },
          {
            name: "Validate Response Quality",
            kind: "agent_step" as const,
            duration: 800,
            attrs: { quality_score: 0.92 },
          },
        ],
      },
    ],
        ...
        children: [
          {
            ...
            kind: "llm_call" as const,
            duration: 8900,
            attrs: { model: "claude-3.5-sonnet", tokens: 3456, cost: 0.1234 },
          },
          {
          ...
          },
          {
            ...
            kind: "llm_call" as const,
            duration: 45000,
            attrs: { model: "claude-3.5-sonnet", tokens: 12456, cost: 0.4567 },
          },
          {
            name: "Run Unit Tests",
            kind: "tool_call" as const,
            duration: 8000,
            attrs: { tool: "pytest", tests_passed: 23, tests_failed: 2 },
          },
          {
            name: "Fix Failing Tests",
            kind: "llm_call" as const,
            duration: 15000,
            attrs: { model: "gpt-4", tokens: 5678, cost: 0.1876 },
          },
          {
            name: "Validate Solution",
            kind: "agent_step" as const,
            duration: 3000,
            attrs: { all_tests_passed: true },
          },
        ],
      },
    ],
        ...
        children: [
          {
            ...
            kind: "tool_call" as const,
            duration: 5000,
            attrs: { tool: "serp_api", results: 50 },
          },
          {
            name: "Scrape Sources",
            kind: "tool_call" as const,
            duration: 25000,
            attrs: { tool: "web_scraper", pages: 15 },
          },
          {
            name: "Extract Key Points",
            kind: "llm_call" as const,
            duration: 35000,
            attrs: { model: "gpt-4-turbo", tokens: 45000, cost: 0.678 },
          },
          {
            name: "Synthesize Findings",
            kind: "llm_call" as const,
            duration: 28000,
            attrs: { model: "gpt-4", tokens: 8900, cost: 0.289 },
          },
          {
            name: "Generate Citations",
            kind: "agent_step" as const,
            duration: 2000,
            attrs: { sources_cited: 12 },
          },
        ],
      },
    ],
        ...
        children: [
          {
            ...
            kind: "tool_call" as const,
            duration: 8000,
            attrs: { tool: "postgres", records: 5000 },
          },
          {
            name: "Validate Schema",
            kind: "agent_step" as const,
            duration: 3000,
            attrs: { valid: 4987, invalid: 13 },
          },
          {
            name: "Transform with LLM",
            kind: "llm_call" as const,
            duration: 65000,
            attrs: { model: "gpt-3.5-turbo", tokens: 89000, cost: 0.445 },
          },
          {
            name: "Write to Warehouse",
            kind: "tool_call" as const,
            duration: 12000,
            attrs: { tool: "bigquery", rows_written: 4987 },
          },
        ],
      },
    ],
        ...
        children: [
          {
            ...
            kind: "llm_call" as const,
            duration: 6000,
            attrs: { model: "gpt-4", subtasks: 3 },
          },
          {
            name: "Delegate to Research Agent",
            kind: "agent_step" as const,
            duration: 45000,
            attrs: { agent: "research-agent" },
          },
          {
            name: "Delegate to Analysis Agent",
            kind: "agent_step" as const,
            duration: 38000,
            attrs: { agent: "analysis-agent" },
          },
          {
            name: "Delegate to Writer Agent",
            kind: "agent_step" as const,
            duration: 42000,
            attrs: { agent: "writer-agent" },
          },
          {
            name: "Merge Results",
            kind: "llm_call" as const,
            duration: 8000,
            attrs: { model: "gpt-4-turbo", tokens: 5600 },
          },
        ],
      },
    ],
          ...
          ? [
              {
                ...
                duration: 5000,
                status: "error",
                attrs: { model: "gpt-4", error: "Rate limit exceeded" },
              },
              {
              ...
              {
                name: "Fallback to Cheaper Model",
                kind: "llm_call" as const,
                duration: 8000,
                status: "error",
                attrs: { model: "gpt-3.5-turbo", error: "Timeout" },
              },
              {
                ...
                duration: 500,
                status: "error",
                attrs: { reason: "Max retries exceeded" },
              },
            ]
          : [
              {
        ...
        children: [
          {
            ...
            kind: "llm_call" as const,
            duration: 800,
            attrs: { model: "text-embedding-3-large", tokens: 45 },
          },
          {
            name: "Vector Search",
            kind: "tool_call" as const,
            duration: 2200,
            attrs: { tool: "pinecone", results: 20 },
          },
          {
            name: "Rerank Results",
            kind: "llm_call" as const,
            duration: 5000,
            attrs: { model: "cohere-rerank", top_k: 5 },
          },
          {
            name: "Generate Answer",
            kind: "llm_call" as const,
            duration: 8500,
            attrs: { model: "gpt-4", tokens: 3456, cost: 0.1234 },
          },
        ],
      },
    ],
