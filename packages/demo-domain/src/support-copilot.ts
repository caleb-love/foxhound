...
function makeSupportTrace(params: {
  ...
  const start = params.startTimeMs ?? (1713000000000 + (params.promptVersion * 100000));
  ...
  return {
    ...
    metadata: {
      ...
      model_name: params.modelName ?? (params.promptVersion >= 18 ? "gpt-4o-mini" : "gpt-4o"),
      ticket_id: `ticket_${params.issueType}_${params.promptVersion}_${params.sessionSuffix ?? "default"}`,
      language: params.language ?? "en",
      user_id: params.userId ?? `customer_${params.issueType}`,
    },
  };
}
...
function atDemoTime(dayOffset: number, hour: number, minute: number): number {
  return DEMO_WEEK_START_MS + (dayOffset * DAY_MS) + (hour * 60 * 60 * 1000) + (minute * 60 * 1000);
}
...
export const supportCopilotCuratedTraces: DemoCuratedTrace[] = [
  {
    ...
    trace: makeSupportTrace({
      ...
      sessionSuffix: "hero_refund_baseline",
    }),
  },
  {
    ...
    trace: makeSupportTrace({
      ...
      sessionSuffix: "hero_refund_regression",
    }),
  },
  {
...
export const supportCopilotBackgroundTraces: Trace[] = [
  makeSupportTrace({
    ...
    startTimeMs: atDemoTime(0, 8, 12),
  }),
  makeSupportTrace({
    id: "trace_bg_refund_clarification_001",
    agentId: "refund-policy-agent",
    promptName: "refund-policy-check",
    promptVersion: 3,
    issueType: "refund",
    ...
    qualityScore: 0.94,
    sessionSuffix: "bg_refund_001",
    startTimeMs: atDemoTime(0, 11, 5),
  }),
  makeSupportTrace({
  ...
  makeSupportTrace({
    ...
    startTimeMs: atDemoTime(1, 15, 42),
  }),
  makeSupportTrace({
    ...
    startTimeMs: atDemoTime(1, 17, 8),
  }),
  makeSupportTrace({
    id: "trace_bg_enterprise_contract_001",
    agentId: "escalation-agent",
    ...
    policyResult: "correct_escalation",
    qualityScore: 0.98,
    sessionSuffix: "bg_enterprise_001",
    startTimeMs: atDemoTime(2, 10, 27),
  }),
  makeSupportTrace({
    ...
    startTimeMs: atDemoTime(3, 9, 44),
  }),
  makeSupportTrace({
    id: "trace_bg_exchange_request_001",
    agentId: "refund-policy-agent",
    promptName: "support-reply",
    promptVersion: 18,
    issueType: "refund",
    ...
    durationMs: 8400,
    escalationRequired: false,
    policyResult: "healthy_exchange_offer",
    qualityScore: 0.87,
    sessionSuffix: "bg_exchange_001",
    startTimeMs: atDemoTime(3, 13, 16),
  }),
  makeSupportTrace({
    id: "trace_bg_duplicate_charge_001",
    agentId: "support-rag-agent",
    promptName: "support-reply",
    promptVersion: 18,
    issueType: "billing",
    ...
    qualityScore: 0.86,
    sessionSuffix: "bg_billing_002",
    startTimeMs: atDemoTime(3, 16, 3),
  }),
  makeSupportTrace({
    id: "trace_bg_multilingual_shipping_001",
    agentId: "support-rag-agent",
    promptName: "support-reply",
    promptVersion: 18,
    issueType: "shipping",
    ...
    durationMs: 7600,
    escalationRequired: false,
    policyResult: "healthy_shipping_answer_multilingual",
    qualityScore: 0.88,
    sessionSuffix: "bg_shipping_es_001",
    startTimeMs: atDemoTime(4, 8, 51),
    language: "es",
    userId: "customer_shipping_es",
  }),
  makeSupportTrace({
    id: "trace_bg_account_lockout_001",
    agentId: "support-router",
    promptName: "support-reply",
    promptVersion: 18,
    issueType: "account",
    ...
    qualityScore: 0.91,
    sessionSuffix: "bg_lockout_001",
    startTimeMs: atDemoTime(4, 12, 24),
  }),
  makeSupportTrace({
    id: "trace_bg_kb_slow_but_ok_001",
    agentId: "support-rag-agent",
    promptName: "support-reply",
    promptVersion: 18,
    issueType: "shipping",
    ...
    qualityScore: 0.79,
    sessionSuffix: "bg_kb_slow_001",
    startTimeMs: atDemoTime(5, 7, 33),
  }),
  makeSupportTrace({
    ...
    startTimeMs: atDemoTime(6, 9, 11),
  }),
  makeSupportTrace({
    id: "trace_bg_weekend_refund_fix_001",
    agentId: "refund-policy-agent",
    promptName: "refund-policy-check",
    promptVersion: 5,
    issueType: "refund",
    ...
    durationMs: 7800,
    escalationRequired: false,
    policyResult: "grounded_partial_refund",
    qualityScore: 0.95,
    sessionSuffix: "bg_refund_fix_001",
    startTimeMs: atDemoTime(6, 13, 47),
  }),
  makeSupportTrace({
    id: "trace_bg_weekend_tracking_001",
    agentId: "support-rag-agent",
    promptName: "support-reply",
    promptVersion: 19,
    issueType: "shipping",
    ...
    durationMs: 6100,
    escalationRequired: false,
    policyResult: "healthy_tracking_answer",
    qualityScore: 0.96,
    sessionSuffix: "bg_tracking_001",
    startTimeMs: atDemoTime(6, 18, 6),
  }),
];
...
export const supportCopilotDatasets: DemoDataset[] = [
  {
    ...
    description: "Trace-derived refund edge cases collected across the week to validate fixes before promotion.",
    itemCount: 41,
    sourceTraceIds: [
      ...
      "trace_bg_refund_clarification_001",
      "trace_bg_exchange_request_001",
      "trace_bg_weekend_refund_fix_001",
    ],
  },
  {
    id: "dataset_escalation_policy_cases",
    name: "escalation-policy-cases",
    description: "Premium and risk-sensitive support cases used to validate human-handoff behavior throughout the incident week.",
    itemCount: 28,
    sourceTraceIds: [
      "trace_vip_chargeback_v18_missed_escalation",
      "trace_vip_chargeback_v19_restored_escalation",
      "trace_bg_enterprise_contract_001",
      "trace_bg_safety_handoff_001",
    ],
  },
  {
    id: "dataset_support_hallucination_guardrails",
    name: "support-hallucination-guardrails",
    description: "Cases derived from unsupported claims, strict-policy failures, and policy-grounding gaps.",
    itemCount: 19,
    sourceTraceIds: [
      "trace_damage_receipt_v18_hallucination",
      "trace_support_refund_v18_regression",
      "trace_bg_multilingual_shipping_001",
    ],
  },
  {
    ...
    sourceTraceIds: [
      ...
      "trace_bg_shipping_status_001",
      "trace_bg_account_help_001",
      "trace_bg_password_reset_001",
      "trace_bg_weekend_tracking_001",
      "trace_bg_kb_slow_but_ok_001",
    ],
  },
  {
    id: "dataset_premium_billing_recovery",
    name: "premium-billing-recovery",
    description: "High-value billing and duplicate-charge cases used to confirm recovery quality for premium customers.",
    itemCount: 17,
    sourceTraceIds: [
      "trace_vip_chargeback_v18_missed_escalation",
      "trace_vip_chargeback_v19_restored_escalation",
      "trace_bg_billing_question_001",
      "trace_bg_duplicate_charge_001",
    ],
  },
];
...
export const supportCopilotEvaluators: DemoEvaluator[] = [
  ...
  {
    id: "eval_latency_guardrail",
    name: "latency_guardrail",
    scoringType: "numeric",
    model: "gpt-4o-mini",
    health: "warning",
    summary: "Tracks whether cheaper routing paths stay inside latency expectations during peak support windows.",
  },
];
...
export const supportCopilotExperiments: DemoExperiment[] = [
  {
    ...
    status: "completed",
    summary: "Version 19 restores correctness with acceptable cost increase across the week's refund edge cases.",
  ...
  },
  {
    ...
    status: "completed",
    summary: "Lower-cost routing preserved quality on common questions after fallback improvements during the later recovery window.",
    winningCandidate: "support-reply v19 fast path",
  },
  {
    id: "exp_premium_billing_recovery",
    name: "premium-billing-recovery",
    datasetId: "dataset_premium_billing_recovery",
    status: "completed",
    summary: "A billing-focused recovery prompt reduced missed escalations without meaningfully increasing handling cost.",
    winningCandidate: "support-reply v19 premium profile",
  },
];
...
export const supportCopilotBudgets: DemoBudgetFixture[] = [
  {
    ...
    status: "critical",
    summary: "Retries, stricter refund misclassification, and manual review loops inflated refund-policy-agent costs beyond budget over the week.",
  },
  {
    agentId: "support-rag-agent",
    budgetUsd: 2500,
    ...
    status: "warning",
    summary: "Knowledge-base instability and fallback logic pushed the main support flow close to budget limits during the incident cluster.",
  },
  {
    agentId: "escalation-agent",
    budgetUsd: 520,
    currentSpendUsd: 471,
    status: "warning",
    summary: "Premium billing reviews and safety escalations increased late-week escalation volume, but remained controllable.",
  },
  {
    agentId: "support-router",
    budgetUsd: 300,
    currentSpendUsd: 126,
    status: "healthy",
    summary: "Intent classification remains cheap and stable even during the recovery window.",
  },
];
...
export const supportCopilotSlas: DemoSlaFixture[] = [
  ...
  },
  {
    ...
    observedDurationMs: 3500,
    observedSuccessRate: 0.997,
    status: "healthy",
    summary: "Routing remained comfortably inside target throughout the seven-day window.",
  },
];
...
export const supportCopilotNotifications: DemoNotificationFixture[] = [
  {
    ...
    kind: "slack",
    status: "warning",
    summary: "Critical refund-policy alerts route here, with one recent failed delivery during the incident cluster worth review.",
  },
  {
  ...
  },
  {
    ...
    kind: "slack",
    status: "healthy",
    summary: "High-value billing and escalation alerts were routed here as premium cases increased late in the week.",
  },
];
    ...
    overviewMetrics: [
      {
        ...
        value: "14",
        supportingText: "Support Copilot is the hero tenant in a broader monitored fleet operating across a full demo week.",
      },
      {
        label: "Runs in last 7d",
        value: "18,426",
        supportingText: "The seeded story now covers a realistic seven-day operating window with both healthy background traffic and visible incident periods.",
      },
      {
        label: "Regressions needing review",
        value: "4",
        supportingText: "Refund behavior remains the top issue, with escalation quality and KB reliability still visible in the same week of activity.",
      },
      {
        label: "Budget risk agents",
        value: "2",
        supportingText: "Refund-policy-agent and support-rag-agent remain the clearest cost hotspots in the current demo narrative.",
      },
    ],
    executiveMetrics: [
      {
        ...
        value: "96.4%",
        supportingText: "Reliability dipped during the mid-week v18 rollout, then partially recovered as the v19 fixes landed late in the seven-day window.",
      },
      {
        label: "Budget exposure",
        value: "$1.4k at risk",
        supportingText: "Overspend is still concentrated in refund-related workflows and support-rag fallback behavior during the incident week.",
      },
      {
        label: "Open regressions",
        value: "4",
        supportingText: "Refund handling, escalation quality, hallucination risk, and KB timeout behavior all remain explorable in the shared narrative.",
      },
      {
        label: "Promotion candidates",
        value: "2",
        supportingText: "support-reply v19 and the lower-cost common-question fast path are both credible promotion candidates now.",
      },
    ],
  };
}
